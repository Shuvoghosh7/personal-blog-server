const { createBlogServices, getBlogService, updateBlogService, deleteBlogService, getBlogByIdService } = require("../services/blog.service")
...
exports.createBlog=async (req, res, next) => {
  ...
  exports.getBlogById=async (req, res, next) => {
    ...
    try {
      ...
      res.status(200).json({
        stauts: "success",
        massage: "successfully create a blog",
        data: blog
      })
    } catch (error) {
      res.status(400).json({
